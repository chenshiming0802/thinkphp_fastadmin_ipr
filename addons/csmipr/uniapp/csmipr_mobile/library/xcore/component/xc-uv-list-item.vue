<!-- 相比uv-list-item，对lg、base和sm增加了宽度和高度的支持，并调整了其大小 -->
<template>
	<!-- #ifdef APP-NVUE -->
...
<style lang="scss" scoped>
	...
	$uv-img-size-sm-width:30px;//xc
	$uv-img-size-sm-height:20px;//xc
	$uv-img-size-base-width:60px;//xc
	$uv-img-size-base-height:40px;//xc
	$uv-img-size-lg-width:120px;//xc
	$uv-img-size-lg-height:80px;//xc
	...
	.uv-list-item__icon-img {
		...
		display: block;
		/* #endif */
		height: $uv-img-size-base-width;
		width: $uv-img-size-base-height;
		margin-right: 10px;
	}
	...
	.uv-list--lg {
		height: $uv-img-size-lg-height;//xc
		width: $uv-img-size-lg-width;//xc
	}

	.uv-list--base {
		height: $uv-img-size-base-height;//xc
		width: $uv-img-size-base-width;//xc
	}

	.uv-list--sm {
		height: $uv-img-size-sm-height;//xc
		width: $uv-img-size-sm-width;//xc
	}
