define(['jquery', 'bootstrap', 'backend', 'table', 'form'], function ($, undefined, Backend, Table, Form) {
    ...
    var Controller = {
        ...
        index: function () {
            ...
            Table.api.init({
                extend: {
                    index_url: 'csmipr/shangbiao_fenlei/index' + Controller._queryString,
                    add_url: 'csmipr/shangbiao_fenlei/add' + Controller._queryString,
                    edit_url: 'csmipr/shangbiao_fenlei/edit',
                    del_url: 'csmipr/shangbiao_fenlei/del',
                    multi_url: 'csmipr/shangbiao_fenlei/multi',
                    import_url: 'csmipr/shangbiao_fenlei/import',
                    table: 'csmipr_shangbiao_fenlei',
                }
            });
            ...
            rebuildAddUrl: function (table) {
                ...
                if ($tabs.length > 0) {
                    ...
                    table.on("pre-body.bs.table", function () {
                        ...
                        options.extend.add_url = 'csmipr/shangbiao_fenlei/add' + queryString
                    })
                }
            }
        }
