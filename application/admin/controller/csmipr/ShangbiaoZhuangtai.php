 ...
 * @icon fa fa-circle-o
 */
class ShangbiaoZhuangtai extends Backend
{

    /**
     * ShangbiaoZhuangtai模型对象
     * @var \app\admin\model\csmipr\ShangbiaoZhuangtai
     */
    ...
    {
        parent::_initialize();
        $this->model = new \app\admin\model\csmipr\ShangbiaoZhuangtai;
